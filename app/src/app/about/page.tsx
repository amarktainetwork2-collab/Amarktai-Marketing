...
const values = [
  { icon: Brain,  title: 'Intelligence First',      description: 'Every feature is designed around AI-driven decision making. We only build what drives real marketing outcomes.' },
  ...
  { icon: Globe,  title: 'Built for Scale',          description: 'Whether you run one brand or twenty, the platform scales with you without adding operational overhead.' },
];
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div variants={staggerContainer(0.1)}
            ...
            <motion.p variants={fadeUp}
              ...
              Every product in the network is built to the same standard: serious, reliable, and genuinely useful — not a toy, not a template.
            </motion.p>
